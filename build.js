...
function main(){
  ...
  html=html.replace(/<head([^>]*)>/i,'<head$1>\n<style id="sunblissCriticalDockPaintStyle">.tabs{visibility:hidden!important}body>.tabs[data-sunbliss-dock-ready="1"]{visibility:visible!important}</style>');
