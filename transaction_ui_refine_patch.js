(function(){
  ...
  function wrap(name){var original=window[name];if(typeof original!=='function'||original.__sunblissTxRefineWrapped)return;function wrapped(){var out=original.apply(this,arguments);refineDetail();return out;}wrapped.__sunblissTxRefineWrapped=true;wrapped.__sunblissOriginal=original;window[name]=wrapped;}
  wrap('renderDetail');wrap('renderMain');window.addEventListener('pageshow',refineDetail);refineDetail();
})();
