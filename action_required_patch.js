(function(){
  ...
  function ensureStyles(){
    ...
    var style=document.createElement('style');style.id='actionRequiredStyles';style.textContent=[
      ...
      '.action-required-meta-copy{min-width:0}.action-required-meta-label{font:500 10px/1.15 Inter,sans-serif;color:var(--muted);margin-bottom:5px}.action-required-meta-value{font:700 12px/1.2 Inter,sans-serif;color:var(--ink);overflow-wrap:anywhere}',
      '@media(max-width:520px){.action-required-card{border-left-width:5px;border-radius:14px}.action-required-head{padding:12px 14px 6px}.action-required-title{font-size:9px}.action-required-status-wrap{gap:5px;padding:5px 8px}.action-required-status-icon svg{width:13px;height:13px}.action-required-status{font-size:9.5px}.action-required-message{padding:10px 14px 14px;font-size:15px;line-height:1.26}.action-required-divider{margin:0 14px}.action-required-meta{padding:0 14px;grid-template-columns:1.25fr 1fr .8fr}.action-required-meta-block{gap:8px;min-height:62px;padding:9px 8px 9px 0}.action-required-meta-block+.action-required-meta-block{padding-left:9px}.action-required-meta-icon{width:30px;height:30px;border-radius:9px}.action-required-meta-icon svg{width:18px;height:18px}.action-required-meta-label{font-size:8.4px;margin-bottom:3px}.action-required-meta-value{font-size:10px}}',
      '@media(max-width:380px){.action-required-head{padding:10px 11px 5px}.action-required-message{padding:9px 11px 12px;font-size:13.5px}.action-required-divider{margin:0 11px}.action-required-meta{padding:0 11px;grid-template-columns:1.18fr 1fr .82fr}.action-required-meta-block{gap:6px;min-height:58px;padding-right:6px}.action-required-meta-block+.action-required-meta-block{padding-left:7px}.action-required-meta-icon{width:26px;height:26px}.action-required-meta-icon svg{width:16px;height:16px}.action-required-meta-label{font-size:7.7px}.action-required-meta-value{font-size:9px}}'
