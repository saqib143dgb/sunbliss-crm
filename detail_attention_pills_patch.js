...
function styles(){
  ...
  var s=document.createElement('style');s.id='detailAttentionPillsStyles';s.textContent=[
    ...
    '.detail-attention-pill[data-kind="note"][aria-selected="true"]{background:rgba(156,90,18,.075);border-color:rgba(156,90,18,.30);color:var(--amber,#9C5A12)}',
    'html.detail-attention-system .detail #activeCustomerNoteCard{display:none!important}',
    'html.detail-attention-system .detail #activeCustomerNoteCard.detail-attention-selected{display:block!important}',
    '.detail-attention-managed.detail-attention-hidden{display:none!important}',
    '#activeCustomerNoteCard.detail-attention-managed{margin-top:0!important;margin-bottom:14px!important}',
