(function(){
  ...
  function ensureStyles(){
    ...
    style.textContent=`
      ...
      .sb-dubai-skyline{position:absolute!important;right:-8px!important;bottom:-2px!important;width:min(54%,620px)!important;height:82%!important;z-index:1!important;opacity:.18!important;pointer-events:none!important;overflow:hidden!important;-webkit-mask-image:linear-gradient(90deg,transparent 0%,rgba(0,0,0,.35) 18%,#000 38%,#000 100%);mask-image:linear-gradient(90deg,transparent 0%,rgba(0,0,0,.35) 18%,#000 38%,#000 100%);}
      ...
      @media(max-width:720px){.sb-dubai-skyline{right:-22px!important;width:61%!important;height:72%!important;opacity:.14!important;}}
      @media(max-width:390px){.sb-dubai-skyline{right:-28px!important;width:64%!important;height:68%!important;opacity:.12!important;}}
    `;
    document.head.appendChild(style);
  }

  function skylineMarkup(){
    return '<div class="sb-dubai-skyline" aria-hidden="true"><svg viewBox="0 0 760 260" preserveAspectRatio="none" role="presentation">'+
  ...
  function apply(){
    ...
    if(!header||header.querySelector('.sb-dubai-skyline'))return;
    header.insertAdjacentHTML('afterbegin',skylineMarkup());
  }
  function wrap(name){
    var original=window[name];
    if(typeof original!=='function'||original.__sunblissSkylineSyncWrapped)return;
    function wrapped(){var out=original.apply(this,arguments);apply();return out;}
    wrapped.__sunblissSkylineSyncWrapped=true;
