(function(){
  ...
  function ensureStyles(){
    ...
    style.textContent=`
      ...
      @media(max-width:720px){
        .sb-dubai-skyline{right:-22px!important;width:61%!important;height:62%!important;opacity:.14!important;}
      }
      @media(max-width:390px){
        .sb-dubai-skyline{right:-28px!important;width:64%!important;height:58%!important;opacity:.12!important;}
      }
    `;
  ...
  function skylineMarkup(){
    return '<div class="sb-dubai-skyline" aria-hidden="true">'+
      '<svg viewBox="0 0 760 260" preserveAspectRatio="xMaxYMax meet" role="presentation">'+
