(function(){
  ...
  style.textContent=`
    ...
    @media(min-width:1024px){
      ...
      html body.sunbliss-ref-desktop #app .topbar.sunbliss-professional-header .sb-desktop-project-visual{
        background-position:141% 66%!important;
      }
    }
  ...
  /* The subtitle only needs bounded startup/font/resize fitting. A previous
     whole-app subtree observer woke up on unrelated dashboard mutations and
     could contribute to visible header repaints, so it is intentionally gone. */
})();