(function(){
  ...
  style.textContent=[
    ...
    '@media(max-width:420px){#app{padding-bottom:calc(126px + env(safe-area-inset-bottom))!important}.tabs{bottom:calc(20px + env(safe-area-inset-bottom))!important;width:calc(100vw - 20px)!important}}'
  ].join('');
