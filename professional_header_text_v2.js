(function(){
  ...
  function ensureStyles(){
    ...
    style.textContent=`
      ...
      .sb-pro-brand-logo{display:none!important;width:52px!important;height:52px!important;min-width:52px!important;min-height:52px!important;max-width:52px!important;max-height:52px!important;aspect-ratio:1 / 1!important;object-fit:contain!important;object-position:center!important;flex:0 0 52px!important;transform:none!important;}
      ...
      @media(max-width:720px){
        ...
        .sb-pro-top{min-height:54px;gap:10px;}.sb-pro-brand{max-width:calc(100% - 74px);flex-direction:row;align-items:center;justify-content:flex-start;gap:9px;}.sb-pro-brand-logo{display:block!important;}.sb-pro-brand-copy{max-width:calc(100% - 61px);}.sb-pro-brand-name{font-size:20px;letter-spacing:.035em;}.sb-pro-brand-sub{margin-top:4px;font-size:6.5px;letter-spacing:.12em;}.sb-pro-signout{height:34px;padding:0 10px;gap:6px;border-radius:10px;font-size:10px;}.sb-pro-signout svg{width:15px;height:15px;}
      ...
      @media(max-width:390px){.topbar.sunbliss-professional-header{min-height:216px!important;padding-left:13px!important;padding-right:13px!important;}.topbar.sunbliss-professional-header::after{left:13px;right:13px;}.sb-pro-brand{max-width:calc(100% - 69px);gap:7px;}.sb-pro-brand-logo{width:48px!important;height:48px!important;min-width:48px!important;min-height:48px!important;max-width:48px!important;max-height:48px!important;flex-basis:48px!important;}.sb-pro-brand-copy{max-width:calc(100% - 55px);}.sb-pro-brand-name{font-size:18px;}.sb-pro-brand-sub{font-size:6px;letter-spacing:.1em;}.sb-pro-signout{padding:0 8px;font-size:9.4px;}.sb-pro-name{font-size:23px;}.sb-pro-role{padding:0 8px;font-size:8px;}.sb-pro-project{font-size:11.3px;}.sb-pro-sync{padding:0 7px;font-size:8.2px;}}
    `;
  ...
  function markup(){
    ...
    return '<div class="sb-pro-top">'+
        '<div class="sb-pro-brand" aria-label="Purvanchal Real Estate Developers LLC"><img class="sb-pro-brand-logo" src="assets/purvanchal-p-desktop-previous.png" alt="Purvanchal logo" decoding="async"><div class="sb-pro-brand-copy"><div class="sb-pro-brand-name">PURVANCHAL</div><div class="sb-pro-brand-sub">REAL ESTATE DEVELOPERS LLC</div></div></div>'+
