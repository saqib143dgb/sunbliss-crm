  ...
  function ensureStyles(){
    ...
    style.textContent=`
      ...
      @media(max-width:720px){
        ...
        .sb-pro-top{min-height:54px;gap:10px;}.sb-pro-brand{max-width:calc(100% - 74px);flex-direction:row;align-items:center;justify-content:flex-start;gap:9px;}.sb-pro-brand-logo-frame{display:grid!important;}.sb-pro-brand-copy{max-width:calc(100% - 61px);}.sb-pro-brand-name{font-size:20px;letter-spacing:.035em;}.sb-pro-brand-sub{margin-top:4px;font-size:6.5px;letter-spacing:.12em;}.sb-pro-signout{height:34px;padding:0 10px;gap:6px;border-radius:10px;font-size:10px;}.sb-pro-signout svg{width:15px;height:15px;}
