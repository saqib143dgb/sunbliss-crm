(function(){
  ...
  style.textContent=[
    '@media(max-width:1023px){',
      ...
      '.overview .sbx-status-card-head{min-height:48px;display:flex;align-items:center;gap:8px;padding:7px 8px;box-sizing:border-box;}',
      ...
      '.overview .sbx-status-icon{width:33px;height:33px;flex:0 0 33px;border-radius:50%;display:grid;place-items:center;background:rgba(255,255,255,.58);position:relative;}',
      '.overview .sbx-status-icon:after{content:"";position:absolute;right:-5px;top:3px;bottom:3px;width:1px;background:rgba(115,108,92,.22);}',
      ...
      '.overview .sbx-status-icon svg{width:21px;height:21px;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round;}',
      '.overview .sbx-status-head-label{min-width:0;padding-left:4px;font:600 8.5px/1.15 IBM Plex Mono,monospace;letter-spacing:.055em;text-transform:uppercase;color:#5e5a52;white-space:normal;}',
      '.overview .pipeline.sbx-status-pipeline .pill-stat-num{margin:17px 13px 0!important;font:600 31px/1 Fraunces,serif!important;color:var(--ink)!important;display:block!important;}',
      ...
      '.overview .pipeline.sbx-status-pipeline.sbx-status-two .pill-stat.sbx-status-card{min-height:136px!important;}',
      '.overview .pipeline.sbx-status-pipeline.sbx-status-two .sbx-status-head-label{font-size:9px;}',
      '@media(max-width:374px){.overview .pipeline.sbx-status-pipeline{gap:6px!important}.overview .sbx-status-card-head{padding:6px!important;gap:6px!important}.overview .sbx-status-icon{width:29px;height:29px;flex-basis:29px}.overview .sbx-status-icon svg{width:18px;height:18px}.overview .sbx-status-head-label{font-size:7.5px}.overview .pipeline.sbx-status-pipeline .pill-stat-num{font-size:28px!important;margin-left:11px!important}}',
    '}'
  ].join('');
