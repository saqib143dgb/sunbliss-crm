(function(){
  ...
  style.textContent = [
    ...
    'main{min-height:0!important;box-sizing:border-box!important;padding-bottom:calc(88px + env(safe-area-inset-bottom))!important;}',
    ...
    '@media(max-width:420px){main{padding-bottom:calc(80px + env(safe-area-inset-bottom))!important;}.footnote.sunbliss-professional-footer{padding:12px 14px 14px!important;font-size:9px;}}'
  ].join('');
