(function(){
  ...
  function install(){
    ...
    function wirePaymentForm(){var t=document.getElementById('pfCreditToggle'),b=document.getElementById('pfCreditFields');if(!t||!b||t.dataset.creditReady==='1')return;t.dataset.creditReady='1';t.addEventListener('click',function(){var open=b.hidden;b.hidden=!open;t.setAttribute('aria-expanded',String(open));t.textContent=open?'− Remove credit note':'+ Add credit note (optional)';if(open){var a=document.getElementById('pfCreditAmount');if(a)setTimeout(function(){a.focus();},0);}});}
