...
function renderReferenceOverview(){
 ...
 '<div class="sb-ref-grid2"><section class="sb-ref-card sb-ref-status"><div class="sb-ref-title">'+icon('sign')+'<span>SPA Status</span></div><div class="sb-ref-status-body two"><span class="sb-ref-icon green">'+icon('sign')+'</span><div class="sb-ref-status-cell" data-proxy="btnSpaSigned"><strong><i class="sb-ref-dot good"></i>'+spa.signed+'</strong><span>Signed</span></div><div class="sb-ref-status-cell" data-proxy="btnSpaPending"><strong><i class="sb-ref-dot warn"></i>'+spa.drafted+'</strong><span>Pending</span></div></div></section>'+
 '<section class="sb-ref-card sb-ref-status"><div class="sb-ref-title">'+icon('award')+'<span>OQOOD Status</span></div><div class="sb-ref-status-body two"><span class="sb-ref-icon green">'+icon('award')+'</span><div class="sb-ref-status-cell" data-proxy="btnOqoodCompleted"><strong><i class="sb-ref-dot good"></i>'+oq.completed+'</strong><span>Completed</span></div><div class="sb-ref-status-cell" data-proxy="btnOqoodPending"><strong><i class="sb-ref-dot warn"></i>'+oq.pending+'</strong><span>Pending</span></div></div></section></div>'+
