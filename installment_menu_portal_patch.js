(function(){
  ...
  function ensureDeleteStyles(){
    ...
    style.textContent=[
      ...
      '#installmentDeleteDialog{width:min(560px,100%);max-height:min(88vh,720px);overflow:auto;background:var(--paper);border:1px solid var(--paper-line);border-radius:18px;padding:18px;box-shadow:0 24px 70px rgba(15,26,38,.42)}',
      '#installmentDeleteDialog h3{font-family:Fraunces,serif;font-size:21px;margin:0 0 3px}',
      '#installmentDeleteDialog .installment-delete-sub{font-size:12px;color:var(--muted);margin:0 0 15px}',
